...
namespace SmartSchool.API.Data
{
    public class SmartContext : DbContext
    {
        ...
        public DbSet<Disciplina> Disciplinhas { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, "Lauro", "Oliveira", 1, "12345688"),
                    new Professor(2, "Roberto", "Soares", 2, "54689954"),
                    new Professor(3, "Ronaldo", "Marconi", 3, "32145678"),
                    new Professor(4, "Rodrigo", "Carvalho", 4, "12345678"),
                    new Professor(5, "Alexandre", "Montana", 5, "32145678"),
                });
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, "Marta", "Kent", "33225555", 1, DateTime.Parse("28/10/2005")),
                    new Aluno(2, "Paula", "Isabela", "3354288", 2, DateTime.Parse("28/10/2005")),
                    new Aluno(3, "Laura", "Antonia", "55668899", 3, DateTime.Parse("28/10/2005")),
                    new Aluno(4, "Luiza", "Maria", "6565659", 4, DateTime.Parse("28/10/2005")),
                    new Aluno(5, "Lucas", "Machado", "565685415", 5, DateTime.Parse("28/10/2005")),
                    new Aluno(6, "Pedro", "Alvares", "456454545", 6, DateTime.Parse("28/10/2005")),
                    new Aluno(7, "Paulo", "José", "9874512", 7, DateTime.Parse("28/10/2005"))
                });
